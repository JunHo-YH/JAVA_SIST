...
<body>
	<div class="wrapper row3 join_row">
		...
		<form action="../member/join_ok.do" method="post" name="join_frm">
		<table class="table">
			<tr>
			...
			<tr>
				...
				<td width=80%>
					<input type=name name="name" id="pwd" class="input-sm" >
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width=80%>
					<input type=name name="email" id="email" class="input-sm" size=45 >
				</td>
			</tr>
			<tr>
				<th width=20% class="text-right">우편번호</th>
				<td width=80%>
					<input type=name name="post" id="post" class="input-sm" size=10 readonly style="float:left" >
			...
			<tr>
				...
				<td width=80%>
					<input type=name name="addr1" id="addr1" class="input-sm" size=45 readonly>
				</td>
			</tr>
			<tr>
				<th width=20% class="text-right">상세주소</th>
				<td width=80%>
					<input type=name name="addr2" id="addr2" class="input-sm" size=45 >
				</td>
			</tr>
			...
			<tr>
				...
				<td width=80%>
					<input type=name name="tel1" id="tel1" class="input-sm" size=5 readonly value="010" style="float:left" >
					<input type=name name="tel2" id="tel2" class="input-sm" size=10 style="float:left">
				</td>
			</tr>
			...
			<tr>
				...
				<td width=80%>
					<textarea row="7" cols="50" name="content"></textarea>
				</td>
			</tr>
