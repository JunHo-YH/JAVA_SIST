...
public class RecipeDetailVO {
	private int no, rno;
	private String chef, chef_poster, title, content, info1, info2, info3, foot_make, chef_info;
	...
	public String getFoot_make() {
		return foot_make;
	}

	public void setFoot_make(String foot_make) {
		this.foot_make = foot_make;
	}
